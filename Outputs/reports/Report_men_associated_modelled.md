...
# Years of Life Lost for men assuming age and comorbidity are associated .
...
![](Report_men_associated_modelled_files/figure-gfm/agedistr-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/repeategraphclearer-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/agestratcomo-1.png)<!-- -->
...
```
    ...
    ## [1,]  0.0000  0.0000  0.0000  0.0000 104.7950 104.7950     0  0.0000      0     0  0.0000
    ## [2,]  0.0000 72.2617  0.0000  0.0000  72.2617  72.2617     0  0.0000      0     0  0.0000
    ## [3,]  0.0000  0.0000  0.0000  0.0000  68.2653   0.0000     0  0.0000      0     0 68.2653
    ## [4,]  0.0000 68.4749 68.4749 68.4749  68.4749   0.0000     0  0.0000      0     0 68.4749
    ## [5,]  0.0000  0.0000  0.0000  0.0000  90.7491   0.0000     0 90.7491      0     0  0.0000
    ## [6,] 98.6017  0.0000  0.0000  0.0000  98.6017   0.0000     0  0.0000      0     0  0.0000
...
![](Report_men_associated_modelled_files/figure-gfm/nonagelp-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/agelp-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/sumlp-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/rate_scale-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/example_plots-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/survival_all-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/yll_wales-1.png)<!-- -->
...
comorbidity, yielded similar per capita YLL; the values were 14 and 11.8
respectively.
...
|:------------------|-----------:|-----------:|-----------:|------------:|
| 0                 |      35.29 |      28.09 |      17.52 |        7.09 |
| 1                 |      34.73 |      25.58 |      16.87 |        6.25 |
| 2                 |      30.26 |      22.41 |      14.55 |        5.29 |
| 3                 |      25.64 |      18.84 |      12.60 |        4.69 |
| 4                 |      22.11 |      16.59 |      10.76 |        4.09 |
| 5                 |      18.58 |      14.15 |       9.13 |        3.56 |
| 6                 |      15.15 |      11.43 |       7.67 |        2.83 |
| 7                 |      11.13 |       9.03 |       6.04 |        2.34 |
| 8                 |       9.19 |       7.17 |       5.29 |        1.84 |
| 9                 |       6.67 |       6.26 |       4.53 |        2.20 |
| 10                |       4.99 |         \- |         \- |        0.99 |
| 11                |         \- |         \- |         \- |        2.47 |
...
![](Report_men_associated_modelled_files/figure-gfm/plot_yll_overall-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/plot_yll_age_como-1.png)<!-- -->
...
![](Report_men_associated_modelled_files/figure-gfm/credible%20intervals-1.png)<!-- -->
...
this approach was 11.8 (95% CI 11-12.7).
