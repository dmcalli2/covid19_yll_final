...
# Years of Life Lost for women assuming age and comorbidity are independent. The correlation between comorbidities was estimated assuming that the association between comorbidities was maximal.
...
![](Report_women_independent_maximal_high_files/figure-gfm/agedistr-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/repeategraphclearer-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/agestratcomo-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/nonagelp-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/agelp-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/sumlp-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/rate_scale-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/example_plots-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/survival_all-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/yll_wales-1.png)<!-- -->
...
|:------------------|-----------:|-----------:|-----------:|------------:|
| 0                 |      34.80 |      25.22 |      17.07 |        8.17 |
| 1                 |      35.25 |      25.46 |      16.59 |        7.78 |
| 2                 |      33.49 |      23.30 |      14.91 |        6.64 |
| 3                 |      26.80 |      20.28 |      13.67 |        6.91 |
| 4                 |      25.17 |      17.32 |      11.73 |        5.48 |
| 5                 |      20.30 |      13.40 |       9.47 |        4.74 |
| 6                 |      13.05 |       9.62 |       7.47 |        4.56 |
| 7                 |      10.94 |       8.20 |       6.33 |        3.47 |
| 8                 |       5.08 |       4.68 |       4.03 |        2.94 |
| 9                 |       3.18 |       2.69 |       2.38 |        1.72 |
| 10                |       2.63 |       2.41 |       2.08 |        1.46 |
| 11                |       2.47 |       2.31 |       1.94 |        1.35 |
...
![](Report_women_independent_maximal_high_files/figure-gfm/plot_yll_overall-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/plot_yll_age_como-1.png)<!-- -->
...
![](Report_women_independent_maximal_high_files/figure-gfm/credible%20intervals-1.png)<!-- -->
