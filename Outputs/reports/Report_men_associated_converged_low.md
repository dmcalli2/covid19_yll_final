...
# Years of Life Lost for men assuming age and comorbidity are associated. The correlation between comorbidities was modelled and the model did/was converged .
...
![](Report_men_associated_converged_low_files/figure-gfm/agedistr-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/repeategraphclearer-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/agestratcomo-1.png)<!-- -->
...
```
    ...
    ## [1,]  0.0000 109.7960  0.0000  0.0000 109.7960  0.0000     0  0.0000  0.0000 109.796  0.0000
    ## [2,]  0.0000   0.0000 86.2866 86.2866  86.2866  0.0000     0  0.0000  0.0000   0.000  0.0000
    ## [3,] 60.8459   0.0000 60.8459 60.8459   0.0000 60.8459     0 60.8459 60.8459   0.000 60.8459
    ## [4,] 67.7812  67.7812  0.0000  0.0000   0.0000 67.7812     0 67.7812  0.0000   0.000 67.7812
    ## [5,]  0.0000   0.0000  0.0000  0.0000  79.0790  0.0000     0  0.0000  0.0000   0.000  0.0000
    ## [6,]  0.0000   0.0000  0.0000  0.0000 105.1530  0.0000     0  0.0000  0.0000 105.153  0.0000
...
![](Report_men_associated_converged_low_files/figure-gfm/nonagelp-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/agelp-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/sumlp-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/rate_scale-1.png)<!-- -->
...
```
    ...
    ## Warning: The SurvGomp function returned NaN for 1 simulated patients
...
![](Report_men_associated_converged_low_files/figure-gfm/example_plots-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/survival_all-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/yll_wales-1.png)<!-- -->
...
comorbidity, yielded similar per capita YLL; the values were 14 and NaN
respectively.
...
|:------------------|-----------:|-----------:|-----------:|------------:|
| 0                 |      35.37 |      25.76 |      16.83 |        7.29 |
| 1                 |      34.99 |      25.42 |      16.73 |        6.69 |
| 2                 |      30.04 |      22.36 |      14.58 |        5.78 |
| 3                 |      26.49 |      19.01 |      12.35 |        5.14 |
| 4                 |      22.00 |      15.93 |      10.64 |        4.36 |
| 5                 |      18.27 |      13.79 |       9.07 |        3.60 |
| 6                 |      14.63 |      11.09 |       7.26 |          \- |
| 7                 |      11.32 |       9.44 |       6.08 |        2.56 |
| 8                 |       7.68 |       6.97 |       4.56 |        2.03 |
| 9                 |         \- |       5.81 |       3.84 |        1.64 |
| 10                |         \- |         \- |       4.14 |          \- |
...
![](Report_men_associated_converged_low_files/figure-gfm/plot_yll_overall-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/plot_yll_age_como-1.png)<!-- -->
...
![](Report_men_associated_converged_low_files/figure-gfm/credible%20intervals-1.png)<!-- -->
...
this approach was 11.6 (95% CI 10.9-12.4).
