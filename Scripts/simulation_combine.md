...
# Years of Life Lost for men assuming age and comorbidity are associated. The correlation between comorbidities was estimated assuming that the association between comorbidities was maximal.
...
![](simulation_combine_files/figure-gfm/agedistr-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/repeategraphclearer-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/agestratcomo-1.png)<!-- -->
...
```
    ...
    ##      atr_fib cancer copd demen     diab h_fail   hypert     ihd renal liver
    ## [1,]  0.0000      0    0     0 109.7960      0 109.7960  0.0000     0     0
    ## [2,] 86.2866      0    0     0  86.2866      0  86.2866 86.2866     0     0
    ## [3,]  0.0000      0    0     0   0.0000      0   0.0000  0.0000     0     0
    ## [4,]  0.0000      0    0     0   0.0000      0   0.0000  0.0000     0     0
    ## [5,]  0.0000      0    0     0   0.0000      0  79.0790  0.0000     0     0
    ## [6,]  0.0000      0    0     0   0.0000      0   0.0000  0.0000     0     0
    ##      stroke
    ## [1,]      0
    ## [2,]      0
    ## [3,]      0
...
![](simulation_combine_files/figure-gfm/nonagelp-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/agelp-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/sumlp-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/rate_scale-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/example_plots-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/survival_all-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/yll_wales-1.png)<!-- -->
...
|:------------------|-----------:|-----------:|-----------:|------------:|
| 0                 |      35.33 |      26.35 |      17.44 |        7.25 |
| 1                 |      35.24 |      26.26 |      16.99 |        6.79 |
| 2                 |      31.57 |      23.33 |      15.64 |        6.55 |
| 3                 |      29.05 |      21.69 |      14.34 |        5.67 |
| 4                 |      28.77 |      20.55 |      13.36 |        5.51 |
| 5                 |      16.61 |      13.43 |       9.87 |        4.98 |
| 6                 |         \- |      10.39 |       8.89 |        5.25 |
| 7                 |       8.93 |       8.09 |       6.86 |        4.18 |
| 8                 |       6.33 |       5.98 |       4.98 |        3.19 |
| 9                 |       4.60 |       4.23 |       3.50 |        1.74 |
| 10                |       4.22 |       4.04 |       3.07 |        1.60 |
| 11                |       4.13 |       3.91 |       3.06 |        1.35 |
...
![](simulation_combine_files/figure-gfm/plot_yll_overall-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/plot_yll_age_como-1.png)<!-- -->
...
![](simulation_combine_files/figure-gfm/credible%20intervals-1.png)<!-- -->
...
this approach was 13.5 (95% CI 12.5-14.4).
